...
But even then, it seems that the base quality scores for all samples are downward biased after BQSR, because we do not have an exhaustive database of variants in the data. This may also be due to the fact that we have a depth filter in our SNP calling step. We should consider filtering out these sites that didn't pass the depth filter from BQSR (I will do this next). 
