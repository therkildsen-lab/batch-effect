...
This is run for comparison's sake. The resulting fastq files will not be used in downstream analyses.
...
These steps are necessary for the SE data becasue intermediate bam files were deleted. 
